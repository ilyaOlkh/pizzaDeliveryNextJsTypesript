...
export default function OrderDetailsItem({ productData, lock = true, deleteFunc, incQuantity, decQuantity }: { productData: OrderDetail, lock?: boolean, deleteFunc: (e: MouseEvent<HTMLButtonElement>) => void, incQuantity: (e: MouseEvent<HTMLButtonElement>) => void, decQuantity: (e: MouseEvent<HTMLButtonElement>) => void }) {
