...
export interface DatabaseInsert {
    ...
    composition: compositionInsert
    pizzadetails: pizzadetailsInsert
    worker: workerInsert
    customer: customerInsert
    order_: order_Insert
    orderdetails: orderdetailsInsert
}