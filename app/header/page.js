                ...
                <div className="header__row header__container">
                    <div className="header__column">
                        <div className="header__select">
                            <Image src="/Common/Location.svg" alt="Location" height={20} width={20} />
                            <form action="/" method="post">
                                <ClientSideComponent component={<select defaultValue="1" name="form[]" data-class-modif="form">
                    ...
                    <div className="header__column">
                        ...
                        <a href="" data-da=".menu__body, 767, first" id="account" className="header__link header__link_right">
                            <Image priority src="/Common/Account.svg" alt="Account" height={20} width={20} />
                ...
                <div className="header__row header__container">
                    <div className="header__menu menu">
                        <a href={settings.globalURL} className="menu__logo">
                            <Image src="/Header/Logo.svg" alt="logo" height={32} width={176} />
                        </a>
                                        ...
                                        <li className="menu__item">
                                            <div data-spollers="" className="spollers">
                                                <details className="spollers__item">
                                                    <summary className="spollers__title">Інше</summary>
                                ...
                                <div className="menu__contact contact">
                                    <div className="contact__row">
                                        <div className="contact__item">
                                            ...
                                            <Image src="/Common/phone.svg" alt="phone" height={20} width={20} /><a href=""> +38 (098) 148-82-28</a>
                                        </div>
                                    </div>
                                    <div className="contact__row">
                                        <div className="contact__item">

                                            <Image src="/Common/gps.svg" alt="gps" height={20} width={20} /><a href="">Харків, просп. Гагаріна, 23</a>
                                        </div>
                                    </div>
                                    <div className="contact__row">
                                        <div className="contact__item">

                                            <Image src="/Common/facebook.svg" alt="facebook" height={20} width={20} /><a href="">Facebok</a>
                                        </div>
                                        <div className="contact__item">

                                            <Image src="/Common/instagram.svg" alt="instagram" height={20} width={20} /><a href="">Instagram</a>
                                        </div>
                                    </div>
                                </div>
                            </nav>
                    ...
                    <a href="" className="header__basket basket">
                        <Image src="/Common/basket.svg" alt="basket" className="basket__img" height={20} width={20} />
